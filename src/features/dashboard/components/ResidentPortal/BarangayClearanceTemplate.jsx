...
export default function BarangayClearanceTemplate({
  ...
  const bodyText = isIndigency
    ? `This is to certify that <strong>${fullNameFormal}</strong>, of legal age, ${
      ...
      }, Filipino citizen, and a bonafide resident of Barangay Sta. Lucia, Novaliches, Quezon City, is known to be an <strong>INDIGENT</strong> member of this barangay and belongs to one of the least privileged families in the community.`
    : isResidency
    ? `This is to certify that <strong>${fullNameFormal}</strong>, of legal age, ${
        resident?.civil_status ?? 'single'
      }, Filipino citizen, is a <strong>bonafide resident</strong> of Barangay Sta. Lucia, Novaliches, Quezon City, with address at ${
        resident?.address_line ?? '—'
      }, and has been residing therein for a considerable period of time.`
    : `This is to certify that <strong>${fullNameFormal}</strong>, of legal age, ${
        resident?.civil_status ?? 'single'
      }, Filipino citizen, and a bonafide resident of Barangay Sta. Lucia, Novaliches, Quezon City, with address at ${
        resident?.address_line ?? '—'
  ...
  return (
    <div className="bg-white mx-auto shadow-sm"
      ...
      <p className="text-sm text-gray-700 mb-12">
        Issued this <strong>{fmt(issuedAt)}</strong> at the Office of the Barangay Captain, Sta. Lucia, Novaliches, Quezon City.
      </p>
      ...
      <div className="flex justify-between items-end mt-16">
        ...
        <div className="text-center">
          <div className="border-t border-gray-800 w-48 pt-1">
            ...
            <p className="text-[10px] text-gray-500">Sta. Lucia, Novaliches, Quezon City</p>
          </div>
        </div>
      </div>
      ...
      <div className="border-t border-gray-300 mt-12 pt-4 text-center">
        <p className="text-[9px] text-gray-400 tracking-wider">
          BARANGAY STA. LUCIA • NOVALICHES, QUEZON CITY • PHILIPPINES
        </p>
