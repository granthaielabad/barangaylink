// src/features/dashboard/pages/ResidentPortalLayout.jsx
// Layout shell for the Resident Portal.
// Uses the shared DashboardSidebar + DashboardHeader like the admin dashboard,
// but with resident-specific nav items (Resident Profile + eID only).
...
// ─────────────────────────────────────────────────────────────
// SIDEBAR (handles mobile overlay + desktop static)
// ─────────────────────────────────────────────────────────────
...
export default function ResidentPortalLayout() {
  ...
  // Derive header title from active route
